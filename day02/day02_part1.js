...
const inputText = fs.readFileSync('./day02_test_input5.txt', { encoding: 'utf-8' });
...
const games = inputLines.map((e) => {
	...
	if (maxDraws.red > numberOfCubes.red || maxDraws.blue > numberOfCubes.blue || maxDraws.green > numberOfCubes.green) {
		return;
	}
